...
def format_question_header_stats(question):
    ...
    return f"asked {asked_text}  accuracy {accuracy_text}  mastery: {mastery_text}"
...
def ask_one_question(user, question_getter, quiz_title, recent_question_ids, jlpt_level):
    question = question_getter(user["id"], recent_question_ids, jlpt_level)
    ...
    if question is None:
        print()
        print("No question found for this mode and level.")
    ...
    print()
    print("Question:")
    print(format_question_header_stats(question))
    print()
...
def show_menu(user):
    ...
    print("5. Reset current user progress")
    print("6. Switch user")
    print("7. Exit")
    print()
